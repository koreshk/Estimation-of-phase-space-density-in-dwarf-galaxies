...
whichgal = 'Bootes_Dwarf_Spheroidal_Galaxy'
infile_kin = './My_Data/'+whichgal+'_spec.csv'
infile_phot = './My_Data/'+whichgal+'_phot.csv'
...
R, surfden, surfdenerr, Rhalf, \
    ...
    walker_api(infile_phot,infile_kin,Nbin)
use_dataRhalf = 'no'
